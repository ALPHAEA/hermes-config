...
- **上海松江每日天气** (`3e33eb3dff29`) — 计划: `{"kind": "cron", "expr": "0 6 * * *", "display": "0 6 * * *"}` — 启用: ✅ — 上次状态: N/A
- **每日AI科技早报** (`8f7ff97d834a`) — 计划: `{"kind": "cron", "expr": "0 8 * * *", "display": "0 8 * * *"}` — 启用: ✅ — 上次状态: N/A
- **daily-hermes-config-sync** (`615d91e235a8`) — 计划: `{"kind": "cron", "expr": "0 6 * * *", "display": "0 6 * * *"}` — 启用: ✅ — 上次状态: N/A
